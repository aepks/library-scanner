...
def matches_isbn(isbn, volumeInfo):
    ...
    for identifier in volumeInfo['industryIdentifiers']:
        try:
            ...
            pass  # ignore non-numeric ISBNs b/c scanner doesn't generate them
            logging.debug("Found a non-numeric identifier: %s",
...
for isbn in args.isbns:
    ...
    if r.status_code != 200:
        logging.warning("Uh-oh, got a non-200 return. Skipping to next ISBN.")
        dump_response(r)
        continue
